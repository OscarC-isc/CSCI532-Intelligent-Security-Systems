...
class MetricsLogger:
    ...
    def log_client_metrics(self, round_num, client_id, loss, accuracy):
        self.client_losses.append({"round": round_num, "client_id": client_id+1, "loss": loss})
        self.client_accuracies.append({"round": round_num, "client_id": client_id+1, "accuracy": accuracy})
